Gem::Specification.new do |spec|
  spec.name        = 'puppet-lint-alias-check'
  spec.version     = '0.1.0'
  spec.homepage    = 'https://github.com/puppet-community/puppet-lint-alias-check'
  ...
  spec.summary     = 'A puppet-lint plugin to check for the alias parameter in resources.'
